...
#   vpc_id              = data.terraform_remote_state.ns_inspection_vpc.outputs.vpc_id

#   subnet_mapping {
#     subnet_id = data.terraform_remote_state.ns_inspection_vpc.outputs.private_subnet_az1_id
#   }

#   subnet_mapping {
#     subnet_id = data.terraform_remote_state.ns_inspection_vpc.outputs.private_subnet_az2_id
#   }
